...
$query = "
SELECT * FROM class_table WHERE class_id = (SELECT teacher_class_id FROM teacher_table 
...
$(document).ready(function(){
  ...
  var dataTable = $('#attendance_table').DataTable({
    "processing":true,//this feature control the processing indicator
    "serverSide":true,//thid option will enable data tables in server side processing mode
    "order":[],//this will remove initial table order from table column
    "ajax":{
